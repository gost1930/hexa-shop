...
const NavBar = () => {
  ...
  return (
    <nav className="flex items-center justify-evenly w-full min-h-16 py-3 shadow-sm border-b border-gray-400 bg-primary dark:bg-gray-900 border-dashed relative">
      <Link to="/" className=' unselectable'><img src={logo} alt="Logo" className='w-32 ' /></Link>
