    ...
    return (
        <section className="flex flex-col md:flex-row gap-4 pt-12 px-6 h-fit">
            ...
            <div className="relative md:w-1/2">
                ...
                <div className="flex flex-col items-center justify-center w-full absolute top-1/2 md:left-16 -translate-y-1/2 md:-translate-x-10 gap-y-5" >
                    ...
                    <BtnLink path="/store" title="Shop Now" />
                </div>
            </div>
